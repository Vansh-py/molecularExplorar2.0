...
@export var semi_major_axis : float = 40
@export var eccentricity     : float = 0.057
@export var orbit_speed      : float = 0.32   # radians per second
@export var orbit_offset     : float = 	2.5   # starting angle (radians)
