...
@export var semi_major_axis : float = 30.0
@export var eccentricity     : float = 0.093
@export var orbit_speed      : float = 0.80   # radians per second
@export var orbit_offset     : float = 1.5   # starting angle (radians)
