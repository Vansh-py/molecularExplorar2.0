...
@export var semi_major_axis : float = 45
@export var eccentricity     : float = 0.046
@export var orbit_speed      : float = 0.23   # radians per second
@export var orbit_offset     : float = 3.0   # starting angle (radians)
