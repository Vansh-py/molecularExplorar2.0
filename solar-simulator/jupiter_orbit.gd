...
@export var semi_major_axis : float = 35.0
@export var eccentricity     : float = 0.049
@export var orbit_speed      : float = 0.43   # radians per second
@export var orbit_offset     : float = 2.0   # starting angle (radians)
