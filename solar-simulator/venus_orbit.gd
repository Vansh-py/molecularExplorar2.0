...
@export var semi_major_axis : float = 20.0
@export var eccentricity     : float = 0.007
@export var orbit_speed      : float = 	1.17 # radians per second
@export var orbit_offset     : float = 0.5   # starting angle (radians)
